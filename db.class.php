...
class db{
	...
	$db=new db("stu");
	var_dump($db->filed("name='小红';sex='男';age='13';home='太原';id=4")->insert());
	var_dump($db->order("id desc")->select(""));      
	var_dump($db->where("id=9")->delete());
	var_dump($db->where("id=3")->filed("name='sjfd',id=9")->update());  
?>